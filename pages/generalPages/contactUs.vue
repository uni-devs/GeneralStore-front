...
<div id="ContactUsPage">
    ...
    <div class="container mt-2">
      <div class="page-header page-header-big text-center" style="background-image: url('/assets/images/contact-header-bg.jpg')">
        <h1 class="page-title text-white">تواصل مع فريق ميم<span class="text-white">نحن هنا للمساعدة</span></h1>
      </div><!-- End .page-header -->
    </div><!-- End .container -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-2 mb-lg-0">
            <h2 class="title mb-1">معلومات التواصل</h2><!-- End .title mb-2 -->
      ...
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'نحن هنا للمساعدة . أرسل لنا بريد الكتروني ، تواصل مع فريق ميم عبر المحادثة المباشرة لنجيب على كافة استفساراتك'
        },

        {
          hid: 'og:url',
          name: 'og:url',
          content: 'https://meem.ps/contactUs'
        },
